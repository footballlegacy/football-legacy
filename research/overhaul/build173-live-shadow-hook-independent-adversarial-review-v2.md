...
- `match-engine/match.html`: `7bdb604227a39b2e560dccb23edb8b3e88515f6d957583cba6ad0aa123526d0a`
...
Candidate-3 repinning changes the separate live V2 cache token and gameplay
host bytes only. The exact `v2Shadow=1` loader, its ten-script order, and all
