# Football Legacy request log — build 165 evidence truth

Updated 10 August 2026 after Josh's observation `FL-MSN0OJP7`, the build-165 corrective pass, a clean **174/174** autonomous gate and four further sequential five-minute Ultimate CPU-v-CPU matches. This remains a playable development base rather than a claim that Josh has accepted every animation, control feel or art-direction choice.
...
| Respect human pass aim and switch to the intended through-ball receiver | **Broken / rejected slightly improved, especially on through ball. refer to latest game log notes** | Josh recorded two passes locking onto a different target and repeated through balls leaving control on the passer. Input-vector authority and post-pass control selection are still wrong. |
...
| D-pad Quick Play navigation in Firefox | **Proven / accepted by Josh yeh fine** | Both DualSense button D-pad and axis-9 hat representations are accepted, and Josh confirms ordinary D-pad navigation is now okay. |
...
| D-pad Down contextual dive | **Proven** | The route is live and no longer crashes. |
