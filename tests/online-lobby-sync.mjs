...
check(onlineHtml.includes('app.js?v=172-away-controller-1'), 'Online shell must bypass the old cached parent script');
check(quickHtml.includes('app.js?v=172-away-controller-1'), 'Quick Play must bypass the old cached lobby script');
