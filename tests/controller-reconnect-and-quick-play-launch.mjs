...
check(quickPlayHtml.includes('app.js?v=174-fl-v2-final-candidate-5'),'Quick Play loads the V2-only candidate bytes while retaining controller-readiness and launch acknowledgement');
