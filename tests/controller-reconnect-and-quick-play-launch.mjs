...
check(quickPlayHtml.includes('app.js?v=174-fl-v2-final-candidate-3'),'Quick Play loads the final-candidate bytes while retaining controller-readiness and launch acknowledgement');
